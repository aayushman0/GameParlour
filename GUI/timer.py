...
class TimerFrame(Frame):
    ...
    def main(self):
        ...
        for i in self.device_range:
            ...
            time_frame = ttk.Frame(timer_frame[i])
            ...
            ttk.Button(
                button_frame, text="Start / Stop", style="Confirm.TButton", command=lambda x=i: self.button(x), width=10
            ).place(relx=0.5, rely=0, relheight=1.0, anchor="n")
